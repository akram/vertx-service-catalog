...
public class MainVerticle extends AbstractVerticle {
	...
	public void start(Future<Void> startFuture) throws Exception {
		...
		// * Configure the `ConfigStoreOptions` instance with the name and the
		...
		// * Create a `ConfigRetriever` instance with the
		// `ConfigRetrieverOptions` instance
	...
	private void deployVerticles(JsonObject config, Future<Void> startFuture) {
		...
		// deployment options
		// * Use `Future` objects to get notified of successful deployment (or
		// failure) of the verticle deployments.
		// * Use a `CompositeFuture` to coordinate the deployment of both
		// verticles.
